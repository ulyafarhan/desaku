...
<body>
    ...
    <div class="biodata">
        <table>
            ...
            <tr>
                ...
                <td>:</td>
                <td>{{ $pemohon->status_perkawinan }}</td>
            </tr>
            <tr>
                <td>Alamat</td>
                <td>:</td>
    ...
    <div class="content">
        <p>Adalah benar warga Gampong Udeung yang telah berdomisili di alamat tersebut di atas selama <strong>{{ $data_isian['lama_tinggal'] }} tahun</strong>.</p>
