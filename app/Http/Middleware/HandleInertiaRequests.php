    ...
    public function share(Request $request): array
    {
        return [
            ...
            'settings' => [
                ...
                'telepon' => \App\Models\PengaturanGampong::get('telepon', '-'),
                'email' => \App\Models\PengaturanGampong::get('email', '-'),
                'alamat' => \App\Models\PengaturanGampong::get('alamat', '-'),
                ...
                'nama_sekdes' => \App\Models\PengaturanGampong::get('nama_sekdes', 'Nama Sekretaris Desa'),
                'nama_operator' => \App\Models\PengaturanGampong::get('nama_operator', 'Nama Operator'),
                'medsos_facebook' => \App\Models\PengaturanGampong::get('medsos_facebook', ''),
                'medsos_instagram' => \App\Models\PengaturanGampong::get('medsos_instagram', ''),
                'medsos_twitter' => \App\Models\PengaturanGampong::get('medsos_twitter', ''),
                'medsos_youtube' => \App\Models\PengaturanGampong::get('medsos_youtube', ''),
                'tahun_anggaran' => \App\Models\PengaturanGampong::get('tahun_anggaran', date('Y')),
